                        ...
                        <div class="post-blog">
                            ...
                            <div class="blog-content">
                                <span class="meta-date"><a
                                        href="#">{{ date('d M Y', strtotime($article['tanggal_terbit'])) }}</a></span>
                                <span class="meta-comments"><a href="#blog-comments">{{ sizeof($comments) }}
                                        Comments</a></span>
                                <span class="meta-author"><a
                                        href="#blog-author">{{ $staff['nama_staff'] }}</a></span>
                                <h3>{{ $article['nama_artikel'] }}</h3>
                                {!! $article['deskripsi'] !!}
                                @if ($article['pdf'])
                                    <a href="{{ asset('storage/' . $article['pdf']) }}"><button
                                            class="btn btn-light">Download PDF<button></a>
                                @endif
                            </div> <!-- /.blog-content -->
                        </div> <!-- /.post-blog -->
                    </div> <!-- /.col-md-12 -->
                    ...
                    <div class="col-md-12">
                        <div id="blog-author" class="clearfix">
                            <a href="#" class="blog-author-img pull-left">
                                <img src="{{ asset($staff['gambar'] == null ? 'images/includes/author.png' : $staff['gambar']) }}"
                                    alt="">
                            </a>
                                        ...
                                        <div class="col-md-6">
                                            <p>
                                                ...
                                                <input type="text" id="name-id" name="name-id"
                                                    wire:model.lazy="newComment.nama">
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>
                                                ...
                                                <input type="text" id="email-id" name="email-id"
                                                    wire:model.lazy="newComment.email">
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                ...
                                                <textarea name="comment" id="comment" rows="5"
                                                    wire:model.lazy='newComment.komentar'></textarea>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input class="mainBtn" value="Send" id="submit" wire:click="comment"
            ...
            <div class="col-md-4">
                <div class="sidebar">
                        ...
                        @foreach ($recentArticle as $recent)
                            <div class="last-post clearfix">
                                <div class="thumb pull-left">
                                    <a href="#"><img
                                            src="{{ asset($recent['gambar'] == null ? 'images/includes/blogthumb1.jpg' : $recent['gambar']) }}"
                                            alt=""></a>
                                </div>
                                <div class="content">
                            ...
                            <div class="col-md-6">
                                <ul>
                                    ...
                                    @for ($i = 0; $i < sizeof($allCategories) / 2; $i++)
                                        <li><a
                                                href="{{ url('/artikel/cat/' . $allCategories[$i]['kategori']) }}">{{ $allCategories[$i]['kategori'] }}</a>
                                        </li>
                                    @endfor
                                </ul>
                            </div>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <p class="light-text">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum
                            nibh, ut fermentum massa justo sit amet risus. Cum sociis natoque penatibus et magnis dis
                            parturient… </p>
                    </div> <!-- /.sidebar-widget -->
                </div> <!-- /.sidebar -->
            </div> <!-- /.col-md-4 -->
