						...
						<div class="overlay">
                            <div class="overlay-inner">
                                <div class="portfolio-infos">
                                    ...
                                    <h3 class="portfolio-title"><a href="{{asset('/portofolio/'.$portofolio['id'])}}">{{$portofolio['nama_portofolio']}}</a></h3>
                                </div>
                                <div class="portfolio-expand">
                                    <a class="fancybox" href="{{asset($portofolio['file'] == null ? 'images/includes/project1.jpg' : 'storage/'.$portofolio['file'])}}" title="Visual Admin">
