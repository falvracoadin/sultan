        ...
        <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Kategori Artikel Baru</p>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="new1">Kategori Artikel</span>
                        <input wire:model.debounce.500ms="kategori" type="text" class="form-control"
                            placeholder="Kategori Artikel" aria-label="kategori" aria-describedby="basic-addon1">
                    </div>
                </div>
